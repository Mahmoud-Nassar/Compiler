...
void output::errorPrototypeMismatch(int lineno, const string& id, std::vector<string>& argTypes) {
   /**cout << "line " << lineno << ": prototype mismatch, function " << id <<
    " expects arguments " << typeListToString(argTypes) << endl;*/
}
	
void output::errorUnexpectedBreak(int lineno) {
	/**cout << "line " << lineno << ":" << " unexpected break statement" <<
	 * endl;*/
}

void output::errorUnexpectedContinue(int lineno) {
	/**cout << "line " << lineno << ":" << " unexpected continue statement" <<
	endl;*/
}
...
void output::errorByteTooLarge(int lineno, const string& value) {
	/**cout << "line " << lineno << ": byte value " << value << " out of "
                                                           "range"<< endl;*/
} 

/**
void output::printBuffer(CodeBuffer& Buffer){
	cout << Buffer.printCodeBuffer() << endl;
}
*/